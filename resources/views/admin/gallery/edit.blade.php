...
@section('body')
 ...
 <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="{{ route('admin.gallery.update') }}" id="form_validation" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <input type="text" class="form-control" name="title" value="{{ $logos->title }}" id="exampleFormControlFile1">
                               ...
                               <div class="form-group">
    <label for="exampleFormControlFile1">Gallery</label>
    <input type="file" class="form-control" name="category_image" id="exampleFormControlFile1">
    <input type="hidden" class="form-control" name="id" value="{{ $logos->id }}" id="exampleFormControlFile1">
     <img src="{{asset('/')}}{{$logos->category_image}}" width="70px" height="70px">
                  ...
                  <button type="submit" class="btn btn-success">Update</button>
                   <a href="{{ route('admin.gallery') }}" type="button" class="btn btn-danger">Cancel</a>
              </form>
            </div>
            <!-- /.card-body -->
          </div>
